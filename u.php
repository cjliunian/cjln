...
<title>PHP探针-UPUPW环境集成包专用版</title>
<meta name="keywords" content="PHP探针,PHP组件,UPUPW,UPUPW集成包,ZendOptimizer,ZendGuardLoader,ionCube,eAccelerator,memcache,XCache,WinCache,SendMail" />
<meta name="description" content="UPUPW环境集成包专用版PHP探针可检测ZendOptimizer,ZendGuardLoader,ionCube,eAccelerator,memcache,XCache,WinCache和SendMail等PHP组件." />
...
<table class="info tablex1">
  ...
  <tr>
    ...
    <td class="fl">
    <a target="_blank" href='<?=_SERVER('PHP_SELF')?>?act=phpinfo'>PHP详细信息</a> | <a target="_blank" href="http://lc/phpMyAdmin/">MySQL管理</a>
    </td>
  </tr>
</table>
...
<table class="info tablex2">
  ...
  <tr>
    <td width="190" class="er" >IMAP电子邮件函数库</td>
    <td width="310" class="fl"><?=function_exists('imap_close') ? YES : NO ?></td>
  </tr>
  <tr>
    <td class="er">SendMail电子邮件支持</td>
    <td class="fl"><?=phpversion('standard') ? YES : NO ?></td>
  </tr>  
</table>
...
<td colspan="5" class="ec">PHP 缓存优化组件</td>
</tr>
<tr>
<td class="el"><span class="er">Zend Optimizer</span></td>
<td class="el">Zend Guard Loader</td>
<td class="el">ionCube Loader</td>
<td class="el">eAccelerator</td>
...
<?}?>
 ...
 <p style="color:#505050; font-size:14px; text-align:center;">&copy;2003-2013 <a href="http://www.upupw.net">WWW.UPUPW.NET</a> 版权所有</p>
</div>
</body>
</html>
