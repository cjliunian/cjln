...
<form id="add-fm" method="post" action="/index.php/Admin/AuthManager/addUsergroup?_=1387851196484" >
...
<script type="text/javascript">
    ...
    function doOK (win) {
        ...
        if(vdfm.check()) {
            ...
            $.ajax({
                type:'post',
                url:'/index.php/Admin/AuthManager/addUsergroup?_=1387851196484',
                data:fmdata,
