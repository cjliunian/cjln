      ...
      <form class="form-vertical login-form" action="/index.php/Admin/Public/login" method="post">
        ...
        <div class="form-group" >
          <div class="input-icon"> <i class="fa fa-user"></i>
            <input type="text" name="username" id="username" class="form-control" required placeholder="用户名" autofocus="autofocus" datatype="s2-18" errormsg="昵称至少6个字符,最多18个字符！">
        ...
        <div class="form-group">
          <div class="input-icon">
            ...
            <input type="text" name="password" id="password" class="form-control" placeholder="密码" data-rule-required="true" data-msg-required="请输入密码.">
            <span class="help-block Validform_checktip"></span>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="help-block" id="alert" style="display: none;">
        <p class="text-success">
          <i class="fa fa-spinner fa-spin"></i>&nbsp;&nbsp;<span id="alert-tip">正在登陆!</span>
          </p>
        </div>
