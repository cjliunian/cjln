	  ...
	  <table width="998" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
		  <tr>
			<td width="136" valign="top" class="ej_dh_zbg">
			   <div class="ejtitlebg"><span class="ejdh_txt">技术支持</span></div>
			   <div class="ej_dh_w">
			      <ul>
			...
			<td width="862" valign="top" class="bg_pb2">
			     <div class="zswz_w">您的位置：<a href="#">首页</a> > <a href="/index.php?m=Home&c=Index&a=aboutUs&chanid=4">技术支持</a> > <span class="dqwz_color"><?php echo ($data["name"]); ?></span></div>	
				 <div class="dh_biti"><?php echo ($data["name"]); ?></div>
				 <div class="neirong_w">
				   <?php echo (htmlspecialchars_decode(stripcslashes($data['content']))); ?>
				 </div>		
			</td>
		   </tr>
		  <tr>
