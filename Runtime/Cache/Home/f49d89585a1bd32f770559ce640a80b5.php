	  ...
	  <table width="998" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
		  <tr>
			...
			<td width="862" valign="top" class="bg_pb2">
				 ...
				 <div class="neirong_w">
				 	<div class="head_word_w">
					    <div class="key_word"><?php echo ($data["title"]); ?></div>
						<div class="other_word">发布日期:<?php echo (date('Y-m-d H:i:s',$data['inputtime'])); ?>  阅读数:<?php echo ($data["hits"]); ?></div>
					 </div>
					 <div class="zhengwen">
